...
%---------------------------------------------------------------------------%
\documentclass[twoside]{ucasthesis}%
...
%->> Document settings
%---------------------------------------------------------------------------%
\usepackage[authoryear,list]{artratex}% document settings
...
\artxifstreq{\artxbib}{bibtex}{\bibliography{Biblio/ref}}{\printbibliography}
